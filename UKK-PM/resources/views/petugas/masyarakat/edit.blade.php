        ...
        <div class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <div class="card-header header-elements-inline">
                            <h4 class="card-title">Edit Masyarakat</h4>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('update.masyarakat',[$masyarakat->id])}}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <fieldset class="mb-3">
         ...
         --}}
                                    <div class="text-right">
                                        <a href="{{route('data.masyarakat')}}" class="btn btn-dark">back</a>
